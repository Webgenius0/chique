...
export const metadata = {
    ...
    description: 'Create your Chique account to discover your unique style, organize your wardrobe, and get personalized fashion recommendations.',
}
// main component
const SignUp = () => {
    return (
                ...
                <div className="w-full flex flex-col lg:gap-4 gap-3 justify-start items-center">
                    ...
                    <div className="w-full flex flex-col">
                        ...
                        <div className="flex gap-1 justify-center items-center">
                            ...
                            <Link className="underline font-semibold text-primary-dark" href={"/auth/sign-in"}>Log In</Link>
                        </div>
                    </div>
                    {/* Social */}
                    <SocialAuth />
