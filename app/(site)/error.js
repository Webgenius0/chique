...
const RootLayoutError = ({ error, reset }) => {
            ...
            >
                <div className="p-8 text-center">
                    ...
                    >
                        ...
                        <button
                            onClick={() => router.push('/')}
                            className="px-5 py-2.5 cursor-pointer  rounded-lg border border-gray-300 font-medium flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors"
                        >
