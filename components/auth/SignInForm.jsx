    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col gap-3">
            ...
            <div className="flex justify-between">
                {/* terms */}
                <label htmlFor="terms" className="flex gap-2 cursor-pointer justify-start items-center">
                    <input
                        type="checkbox"
                        id="terms"
                        defaultChecked
                ...
                {/* forgot password */}
                <Link href="/auth/forgot-password" className="text-[##0D0E10] text-base underline">Forget your password</Link>
            </div>
            {/* submit button */}
