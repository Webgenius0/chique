    ...
    return (
        <>
            ...
            <div className="xs:mt-6 mt-3 flex justify-between items-center w-full gap-4">
                ...
                <button
                    onClick={next}
                    className={`cursor-pointer px-4 py-2 sm:px-6 sm:py-3 rounded-lg text-white transition-colors text-sm sm:text-base ml-auto ${currentQuestion.is_required && !currentAnswer
