  ...
  return (
    ...
    >
      ...
      <nav className="w-full pl-6 py-8 h-screen flex flex-col justify-start gap-1 overflow-y-auto">
        ...
        <NavLink
          href="/"
          className="w-full text-primary-dark hover:bg-primary-dark hover:text-white rounded-tl-lg text-xl rounded-bl-lg px-4 py-3 flex justify-start items-center gap-3 transition-colors duration-300"
        >
